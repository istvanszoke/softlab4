...
Mivel többen dolgozunk egyszerre a projekten, ezért fontos, hogy mindenki hozzá tudjon férni a legfrissebb forráskódhoz és dokumentációhoz. Ezen felül elsődleges szempont, hogy a párhuzamosan dolgozó csapataggok munkája könnyen integrálható legyen a közponi (beadandó) kózbázisba. Ehhez mi a \textbf{Git} verziókezelő rendszert, központi tárhelynek pedig a \textbf{GitHubot}  használjuk, különböző kiegészítésekkel. Ez lehetőséget biztosít a kód könnyű nyomonkövetésére, illetve
...
\begin{enumerate}
    ...
    \item \textbf{TravisCI:} a projekt folyamatos integrációt használ. Ez minden \textit{Pull Requestre} automatikusan lefut, és ez csak akkor fogadható el a közbonti kódbázisba, ha a futás sikeres volt. Ezzel több problémát is el tudunk kerülni. Mivel a TravisCI először lefordítja a kódot, ezért szintaktikailag hibás, vagy rossz Java szabványt használó kód nem kerülhet a fő ágba. Ezután azonban futtatásra kerülnek a projekthez tartozó unit testek is, így olyan kód sem fogadható
