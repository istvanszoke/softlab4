...
\endhead
NF001 & 
Bármilyen JRE6-al rendelkező rendszeren legyen futtatható az elkészített szoftver.
...
NF006 & 
A felhasználóknak legyen ismeretük PC-k (personal computer) alapvető kezelésében Windows operációs rendszeren. 
& nincs & alapvető & megrendelő & ... \tabularnewline \hline
NF007 & 
A felhasználók fizikailag és mentálisan legyenek képesek billentyűzet és egér használatára.
& nincs & alapvető & megrendelő & ... \tabularnewline \hline
NF008 & A megrendelt program dokumentálva legkésőbb május 15-ig kerüljön átadásra. 
